  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`max-mobile:translate-x-[-50%] absolute  max-mobile:w-[200px]  h-[300px]  bg-[#424347]  rounded-xl capitalize overflow-scroll transition-all duration-300 ease-out  scale-y-0 origin-top `}
        style={{
          width: dropdownWidth,
        }}
      >
