...
export const SlideOne = () => {
  ...
  useEffect(() => {
    ...
    // resizing image on click on main div
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://sparkel-world-studio.s3.ap-south-1.amazonaws.com/slide2sk.jpeg')",
        }}
      ></div>
      {/* image slide */}
      <div
        ...
        style={{
          backgroundImage:
            "url('https://sparkel-world-studio.s3.ap-south-1.amazonaws.com/slide2.jpeg')",
      ...
      >
        ...
        <div
          ...
          className={`${animatedWordStyle} stroke-2 stroke-[#23252d]  text-[20px] text-white `}
          style={{
        ...
        <div
          ref={pushIntoImageContent}
          className={`${paraStyle} stroke-2 stroke-[#23252d]  text-white `}
        >
          Right design and right ideas matter a lot of in interior design
          business. a style that makes a statement.
        </div>
