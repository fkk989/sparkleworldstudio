...
import { ServiceDeletePage } from "./DeletePage";
import { ServiceEditPage } from "./EditPage";
...
export const ServiceCard: React.FC<ProjectCardProps> = ({
  imageUrl,
  title,
  info,
  onClick,
    ...
    <div className="cursor-pointer ">
      ...
      {admin && (
        <div className="flex justify-end items-center gap-[20px]">
          {/* <ServiceDeletePage projectId={id} />
          <ServiceEditPage projectId={id} /> */}
        </div>
      )}
    </div>
  );
